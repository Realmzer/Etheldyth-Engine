...
class PlayState extends MusicBeatState
{
	...
	public var combobreakTxt:FlxText;
	var timeTxt:FlxText;
	...
	override public function create()
	{
		...
		combobreakTxt = new FlxText(0, healthBarBG.y + -635, FlxG.width, "", 60);
		combobreakTxt.setFormat(Paths.font("vcr.ttf"), 20, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		combobreakTxt.scrollFactor.set();
		combobreakTxt.borderSize = 1.25;
		combobreakTxt.visible = !ClientPrefs.hideHud;
		add(combobreakTxt);
		...
		if (ClientPrefs.ythhud) {
			scoreTxt.visible = !ClientPrefs.ythhud;
			timeBar.visible = !ClientPrefs.ythhud;
			timeBarBG.visible = !ClientPrefs.ythhud;
			timeTxt.visible = !ClientPrefs.ythhud;
			iconP2.visible = !ClientPrefs.ythhud;
			iconP1.visible = !ClientPrefs.ythhud;
			healthBar.visible = !ClientPrefs.ythhud;
			healthBarBG.visible = !ClientPrefs.ythhud;
		}
	...
	public function updateScore(miss:Bool = false)
	{
		...
		if (ClientPrefs.ythhud) {
			combobreakTxt.text = 'Combo Breaks: ' + songMisses;	
		}

		if(ClientPrefs.scoreZoom && !miss && !cpuControlled && !ythhud)
		{
